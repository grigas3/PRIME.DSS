////---------------------------------
////---------------------------------
//// C# Fuzzy Logic API from Antonio Leonardo
...
//        /// <returns></returns>
//        public static string GetInference(Expression<Func<TEntity, bool>> expression, ResponseType type,
...
//        /// <param name="entityItem"></param>
//        /// <returns></returns>
//        public static InferenceResult<TEntity> GetInference(Expression<Func<TEntity, bool>> expression,
//            IEnumerable<TEntity> entities)
//        {
...
//        {
//            string result = null;
//            InferenceInternal<TEntity> InferenceResultInternal =
//                (new FuzzyLogic<TEntity>(expression)).GetBruteInferenceCollection(entityItem);
...
//        /// <param name="entityItem"></param>
//        /// <returns></returns>
//        public static Inference<TEntity> GetInference(Expression<Func<TEntity, bool>> expression,
//            TEntity entityItem)
//        {
//            return (new FuzzyLogic<TEntity>(expression)).GetBruteInferenceCollection(entityItem)
//                .InternalToPublicConversion();
//        }
...
//        /// <returns></returns>
//        private IEnumerable<IntermediateInferenceItemInternal> GetBruteInferenceCollectionIntermediate(
//            TEntity entity)
//        {
...
//                };
//                string[] breakApartExpressionByAndAlso = this.BrokedBooleanExpressionsByOrOperator[i]
//                    .Split(new string[] {" AndAlso "}, StringSplitOptions.None);
...
//                        {
//                            bool rating = this.ProcessFilter(breakApartExpressionByAndAlso[j], entity,
//                                this._propertiesNames[x]);
...
//                Data = entity
//            };
//            IntermediateInferenceItemInternal minErrors = GetBruteInferenceCollectionIntermediate(entity)
//                .OrderBy(x => x.ErrorsQuantity).FirstOrDefault();
...
//                    ratingResult = (bool)DynamicLinq.Core.DynamicExpressionParser.ParseLambda(typeof(TEntity), typeof(bool),
//                        newFilter).Compile().DynamicInvoke(invalidData);
//                    isMatch = true;
//                }
...
//                    else
//                    {
//                        if (charsIdWithStartParenteses.SequenceEqual(Enumerable.Range(1,
//                            charsIdWithStartParenteses.Count)))
//                        {
//                            filter = filter.Remove(filter.LastIndexOf(LAST_BRACKET) - 1, 1);
//                            newFilter = filter;
//                            charsIdWithEndParenteses.Remove(charsIdWithEndParenteses.LastOrDefault());
//                        }
//                        else if (charsIdWithEndParenteses.SequenceEqual(Enumerable.Range(1,
//                            charsIdWithEndParenteses.Count)))
//                        {
//                            filter = filter.Remove(filter.IndexOf(FIRST_BRACKET), 1);
//                            newFilter = filter;
//                            charsIdWithStartParenteses.Remove(charsIdWithStartParenteses.FirstOrDefault());
...
//        private void GetAllValidConditionalsByRightExpression(ExpressionModel tree,
//            ref List<string> finalResult,
...
//                    {
//                        this.GetAllValidConditionalsByRightExpression(tree.LeftExpression, ref finalResult,
//                            selectedType);
//                    }
//                }
//                else
...
//        /// <param name="selectedType"></param>
//        private void GetAllValidExpressions(ExpressionModel tree, ref List<BinaryExpression> finalExpressions,
//            ExpressionType selectedType)
//        {
//            if (null != tree.RightExpression)
//            {
