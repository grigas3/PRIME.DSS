...
namespace PRIME.Core.DSS
{
    ...
    public class DSSValueMapping : IDSSValueMapping
    {
        ...
        //[JsonIgnore]
        [Description(
            "NumericMapping is used to scale and translate if required the original numeric value BEFORE  are use to map continuous values to specific DEXI discrete input values")]
        ...
        public bool Numeric
        {
            get { return !string.IsNullOrEmpty(ValueType) && ValueType.ToLower() == "numeric"; }
        }
