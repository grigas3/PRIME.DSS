...
namespace PRIME.Core.Service.Notification
{
    ...
    public static class EmailNotification
    {
        ...
        public static void Notify(string from, string to, string body, string subject, string userName, string password,
            string smtpServer, string smtpServerPort, IEnumerable<string> cc)
        {
