...
namespace PRIME.Core.Web.Migrations
{
    ...
    [Migration("20211007084723_20211007")]
    partial class _20211007
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRIME.Core.Context.Entities.DSSModelInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PRIME.Core.Context.Entities.DSSModelInfo", b =>
                {
                    b.HasOne("PRIME.Core.Context.Entities.CDSClient")
                        .WithMany("Models")
                        .HasForeignKey("CDSClientId");
                });
